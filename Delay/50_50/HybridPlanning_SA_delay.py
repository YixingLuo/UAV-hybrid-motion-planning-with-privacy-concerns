        ...
        if flag:
            ...
            while start <= len(trajectory_plan) - (math.ceil(delay) + 1):
                ...
                if (caculate_privacy_surround(grid, point, occ_grid_known, privacy_radius)) > 0:
                    ...
                    # next_idx = min(affect_path[0][1], len(trajectory_p
                    ...
                    if T_plan >= distance:
                        replantime += 1
                        aStar_pp = AStar(occ_grid_known, pri_grid_known, grid, privacy_sum, current_p, next_p, [1, 2, 3, 4],
                        ...
                        if no_solution_flag > 0:
                            ...
                            log.info(
                                ...
                                % (
                                    ...
                                    no_solution_flag,
                                    PR_temp_sum_known, length_PP, T_plan_optimal))
                            aStar = AStar(occ_grid_known, pri_grid_known, grid, privacy_sum, current_p, next_p, [1, 2, 3, 4],
