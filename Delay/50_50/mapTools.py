        ...
        for j in range(grid_y):
            for k in range(grid_z):
                if occ_grid[i][j][k] == 2 or occ_grid[i][j][k] == 3 or occ_grid[i][j][k] == 4:
                    ...
                    # occ_grid_known[i][j][k] = 0
                    # print (occ_grid_known[i][j][k], i,j,k)
                # if occ_grid[i][j][k] == 7 or occ_grid[i][j][k] == 8:
                    # occ_grid_known[i][j][k] = 0
        ...
        for j in range(grid_y):
            for k in range(grid_z):
                if occ_grid_known[i][j][k] != occ_grid[i][j][k]:
                    a += 1
                    # print(i, j, k, occ_grid_known[i][j][k], occ_grid[i][j][k], a)
    # print(privacy_threshold, restricted_area_num, a, occ_grid_know_ratio)
