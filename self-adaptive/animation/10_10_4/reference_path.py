...
def PathInitial(config, reinitial_flag, iteration, log, num):
    ...
    if reinitial_flag == 1:
        ...
        # objective_list.append([2, 0, 0])
        # objective_list.append([2, 0, 7])
        # objective_list.append([2, 5, 7])
        # objective_list.append([2, 5, 9])
        # objective_list.append([2, 9, 9])

        objective_list.append([2, 0, 0])
        objective_list.append([2, 0, 7])
        objective_list.append([2, 5, 7])
        objective_list.append([2, 5, 4])
        objective_list.append([2, 9, 4])
        objective_list.append([2, 9, 0])
        ...
        for i in range(1, len(objective_list)):
            ...
            if delta_x > 0:
                for j in range(abs(delta_x)):
                    reference_path.append([2, objective_list[i-1][1] + j, objective_list[i-1][2], 1])
            elif delta_x < 0:
                for j in range(abs(delta_x)):
                    reference_path.append([2, objective_list[i-1][1] - j, objective_list[i-1][2], 1])
            elif delta_y > 0:
                for j in range(abs(delta_y)):
                    reference_path.append([2, objective_list[i - 1][1], objective_list[i - 1][2] + j, 1])
            elif delta_y < 0:
                for j in range(abs(delta_y)):
                    reference_path.append([2, objective_list[i - 1][1], objective_list[i - 1][2] - j, 1])
        ...
        reference_path.append([2, 9, 0, 1])
        reference_path.append([1, 9, 0, 1])
        reference_path.append([0, 9, 0, 1])
