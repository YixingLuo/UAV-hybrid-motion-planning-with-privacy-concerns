...
if __name__ == '__main__' :
    ...
    for num in range(29, 30):
        ...
        mlab.points3d(0, 0, 0, mode='cube', color=(1, 1, 0), scale_mode='none', scale_factor='0.5')
        mlab.points3d(9, 0, 0, mode='cube', color=(1, 1, 0), scale_mode='none', scale_factor='0.5')
        ...
        mlab.savefig(os.getcwd() + '/pic/' + str(num)+'.jpg', size = (4000,2250), figure=mlab.gcf(), magnification=3)