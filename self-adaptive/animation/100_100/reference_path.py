...
def PathInitial(config, reinitial_flag, iteration, log, num):
    ...
    if reinitial_flag == 1:
        ...
        objective_list.append([1, 0, 32])
        objective_list.append([1, 51, 32])
        objective_list.append([1, 75, 32])
        objective_list.append([1, 75, 49])
        objective_list.append([1, 84, 49])
        objective_list.append([1, 84, 99])
        objective_list.append([1, 99, 99])

        x_list = [0, 34, 42, 50, 51, 59, 67, 75, 84, 99]
        y_list = [0, 16, 32, 49, 99]

        # while objective_list[-1] != [1, 99, 99]:
        ...
        #         # print(index_x, index_x + 1, now_index_x, len(x_list)-1)
        #         # if x_list[now_index_x] == 0:
        #             # continue
        ...
        reference_path.append([1, 99, 99, 1])
        reference_path.append([0, 99, 99, 1])
